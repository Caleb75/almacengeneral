        ...
        <form action="soli_guardar.php" method="POST"> 
          ...
          <div class="row gy-5">
            ...
            <div class="col-4">
              ...
              <input type="text" class="form-control" id="recipient-name" name="Fecha_Hora">
            </div>
            <div class="col-4">
      ...
      <div class="modal-body">
        <form action="conexionCon.php" method="POST"> 
          ...
          <div class="col-4">
              ...
              <input type="text" class="form-control" id="recipient-name" name="fecha">
            </div>
            <div class="col-4">
            ...
            <div class="col-4">
              ...
              <input type="text" class="form-control" id="recipient-name" name="fechaAct">
            </div>
            <label for="recipient-name" class="col-form-label">*Datos del Control*</label>
            <div class="row gy-5">
            <div class="col-4">
