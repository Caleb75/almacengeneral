...
<center><h1>Control de Inventario Almacen</h1></center>
<hr>
<div class="row">
        ...
        <td><a href="pdfControl.php?id=<?php echo $res['id']; ?>" class="btn btn-success"><i class="bi bi-file-earmark-check"></i></a></td>
