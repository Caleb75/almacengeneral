...
<div class="row">
        ...
        include("conexion.php");
      	$query="SELECT * FROM tarja_exp";
      	$resultado = $cn->query($query);
	      foreach($resultado as $res){
  	     ?>
        <tr> 
        <td><?php echo $res['id']; ?></td>
        <td><?php echo $res['agente_A']; ?></td>
        <td><?php echo $res['cliente']; ?></td>
        <td><?php echo $res['destino']; ?></td>

        <td><a href="pdfTarja.php?id=<?php echo $res['id']; ?>" class="btn btn-success"><i class="bi bi-file-earmark-check"></i></a></td>
        <td><a href="eliminarTarja.php?id=<?php echo $res['id']; ?>" class="btn btn-danger"><i class="bi bi-file-earmark-x"></i></a></td>
