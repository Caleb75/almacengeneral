...
while($row = $resultado->fetch_assoc()){
	...
	$pdf->SetXY(10,60);
	$pdf->Cell(60,10, utf8_decode('Numero de Contenedor'),1,0,'C',0);
    $pdf->Cell(60,10, utf8_decode('Fecha de inspeccion  '),1,0,'C',0);
    $pdf->Cell(60,10, utf8_decode('Lugar de inspeccion '),1,0,'C',0);
	$pdf->SetXY(10,70);
    ...
    $pdf->Ln(15);
    $pdf->Cell(80,10, utf8_decode('Via'),1,0,'C',0);
    $pdf->Cell(100,10, utf8_decode($row['via']),1,0,'C',0);
    $pdf->Ln(15);
    $pdf->Cell(80,10, utf8_decode('Nombre del solicitante de inspeccion'),1,0,'C',0);
    $pdf->Cell(100,10, utf8_decode($row['nombre_Solicicitante']),1,0,'C',0);
    $pdf->Ln(15);
    $pdf->Cell(80,10, utf8_decode('Tipo de Operacion'),1,0,'C',0);
    $pdf->Cell(100,10, utf8_decode($row['tipo_de_Op']),1,0,'C',0);
	$pdf->Ln(15);
    $pdf->Cell(80,10, utf8_decode('Nombre del Servicio'),1,0,'C',0);
    $pdf->Cell(100,10, utf8_decode($row['nombre_Ser']),1,0,'C',0);
    $pdf->Ln(15);
    $pdf->Cell(80,10, utf8_decode('Metodo de Trasporte'),1,0,'C',0);
    $pdf->Cell(100,10, utf8_decode($row['metodo_Trans']),1,0,'C',0);
    $pdf->Ln(15);
    $pdf->Cell(80,10, utf8_decode('Trasportista o Gondola de Ferrocarril'),1,0,'C',0);
    $pdf->Cell(100,10, utf8_decode($row['traspor_Gondo']),1,0,'C',0);
    $pdf->Ln(15);
    $pdf->Cell(45,10, utf8_decode('Empaque/Presentacion'),1,0,'C',0);
    $pdf->Cell(45,10, utf8_decode('Marca'),1,0,'C',0);
    $pdf->Cell(45,10, utf8_decode('Tonelaje'),1,0,'C',0);
    $pdf->Cell(45,10, utf8_decode('Bultos'),1,0,'C',0);
    $pdf->SetXY(10,185);
