...
?>
  ...
  <form method="POST" enctype="multipart/form-data">
    <center><h1>Información usuarios</h1></center>  
     ...
     <?php echo "<img src='Fotos/"; echo $res['Foto']; echo "' style='height: 200px; width: 20s%; padding-top: 1%;'>"; ?>
            ...
            <input type="text" class="form-control" id="recipient-name" name="identificador" value="<?php echo $res['identificador']; ?>" disabled>
            </div>
            <div class="col-6">
            <label for="recipient-name" class="col-form-label">Nombres:</label>
            <input type="text" class="form-control" id="recipient-name" name="nombre" value="<?php echo $res['nombre']; ?>" disabled>
            </div>
            <div class="col-6">
            <label for="recipient-name" class="col-form-label">Apellidos:</label>
            <input type="text" class="form-control" id="recipient-name" name="apellidos" value="<?php echo $res['apellidos']; ?>" disabled>
            </div>
            <div class="col-6">
            <label for="recipient-name" class="col-form-label">Telefono:</label>
            <input type="number" class="form-control" id="recipient-name" name="telefono" value="<?php echo $res['telefono']; ?>" disabled>
          </div>
          <div class="col-6">
            <label for="recipient-name" class="col-form-label">Correo electronico:</label>
            <input type="email" class="form-control" id="recipient-name" name="email_user" value="<?php echo $res['email_user']; ?>" disabled>
          </div>
          <div class="col-6">
            <label for="recipient-name" class="col-form-label">Contraseña:</label>
            <input type="password" class="form-control" id="recipient-name" name="contraseña" value="<?php echo $res['contraseña']; ?>" disabled>
            <div class="col-auto">
          ...
          <div class="col-6">
            ...
            <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="rol_id" value="<?php echo $res['rol_id']; ?>" disabled>
          ...
          <div class="col-6">
            ...
            <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="status" value="<?php echo $res['status']; ?>" disabled>
