...
<center><h1>Entrada almacen</h1></center>
<hr>
<div class="row">
        ...
        include("conexion.php");
      	$query="SELECT * FROM entrada_alm";
      	$resultado = $cn->query($query);
	      foreach($resultado as $res){
  	     ?>
        <tr> 
        <td><?php echo $res['id']; ?></td>
        <td><?php echo $res['folioalm']; ?></td>
        <td><?php echo $res['clientes']; ?></td>
        <td><a href="pdfEA.php?id=<?php echo $res['id']; ?>" class="btn btn-success"><i class="bi bi-file-earmark-check"></i></a></td>
        <td></td>
        <td><a href="eliminarEA.php?id=<?php echo $res['id']; ?>" class="btn btn-danger"><i class="bi bi-file-earmark-x"></i></a></td>
