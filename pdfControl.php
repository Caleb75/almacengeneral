...
while($row = $resultado->fetch_assoc()){
    ...
    $pdf->SetXY(16,60);
	$pdf->Cell(60,10, utf8_decode('Fecha de emision'),1,0,'C',0);
    $pdf->Cell(60,10, utf8_decode('Numero de Revision  '),1,0,'C',0);
    $pdf->Cell(60,10, utf8_decode('Fecha de Actulizacion '),1,0,'C',0);
	$pdf->SetXY(16,70);
    ...
    $pdf->Ln(20);
    $pdf->SetX(16);
	$pdf->Cell(30,10, utf8_decode('Codigo'),1,0,'C',0);
    $pdf->Cell(30,10, utf8_decode('Descripcion'),1,0,'C',0);
    $pdf->Cell(30,10, utf8_decode('Existencias'),1,0,'C',0);
    $pdf->Cell(30,10, utf8_decode('Entradas'),1,0,'C',0);
    $pdf->Cell(30,10, utf8_decode('Salidas'),1,0,'C',0);
    $pdf->Cell(30,10, utf8_decode('Stock'),1,0,'C',0);
	$pdf->SetXY(16,100);
